...
mysql_select_db('video');
 ...
 $video=$_GET['video'];  //video id from view to view1 selected..
 ...
 // player info give the source of file in source tag..
?>
...
<?php  // to download the video simply give the link of file ..
